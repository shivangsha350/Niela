...
const techLayers = [
  {
    ...
    description:
      "100% GOTS certified organic cotton that feels velvety soft on your skin. Extremely breathable, hypoallergenic, and completely free of chemicals or synthetic fragrances.",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    description:
      "Double wings design and protective side barriers keep the flow centered, ensuring complete protection from any accidental side leaks during heavy movements.",
  },
  {
    number: "04",
    name: "Breathable Backing Film",
    description:
      "A corn-starch based biodegradable barrier film that prevents moisture from escaping while allowing heat to pass through, keeping you fresh and sweat-free.",
  },
];
          ...
          <div className="lg:col-span-5 space-y-8 flex flex-col justify-between h-full">
            ...
            <motion.div className="space-y-4" variants={itemVariants}>
              ...
              <p className="text-sm sm:text-base text-brand-slate leading-relaxed">
                We redesigned the sanitary pad from scratch. By replacing
                plastic films and petrochemical gels with organic cotton and
                plant-based absorbents, we created a pad that is ultra-thin,
                highly absorbent, and soft as a cloud.
              </p>
            ...
            >
              <div className="relative w-full h-full max-w-[320px]">
                {techLayers.map((layer, index) => {
                  const styleKey = layer.number as
                    | "01"
                    | "02"
                    | "03"
                    | "04";
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        ...
                        transition:
                          "transform 0.4s cubic-bezier(0.25, 1, 0.5, 1), opacity 0.3s ease, border-color 0.3s ease, shadow 0.3s ease",
                      }}
